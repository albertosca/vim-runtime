...
" vim-claude-code se autodetecta incompatível (checa has('terminal'), que
" no Neovim não existe da mesma forma) — desligado aqui só evita o erro de
" startup, sem mudar nada pro lado Vim.
...
let g:pathogen_disabled = ['vim-claude-code', 'coc.nvim',
...
" Pendências fechadas: snippets, yank history
